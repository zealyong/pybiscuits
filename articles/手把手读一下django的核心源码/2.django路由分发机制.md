 ...
 * @LastEditTime: 2021-06-08 23:37:56
-->
...
# 处理请求核心代码的基类，可以说是整个django最重要的部分
class BaseHandler:
...
# 接上BaseHandler.resolve_request中的resolve方法
class URLResolver:
...
整个调用流程有个类处理函数描述的很清晰（这里的源码不是每次请求都会走到，只是流程写的很清晰所以复制过来供大家参考一下）
